...
class ClientController extends Controller
{
    ...
    public function postNewOrder(Request $request, $locale){
        ...
        if($order->save()){
            return redirect()->route('client.submit-order',array($locale,$ref_number));
        }
    ...
    public function postEditOrder(Request $request, $locale, $id){
        ...
        if($order){
            ...
            if($order->update()){
                return redirect()->route('client.submit-order',array($locale,$order->id));
            }
            return abort(403,'Try Again!');
        }
