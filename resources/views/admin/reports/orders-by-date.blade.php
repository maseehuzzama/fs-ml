...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-xs-9">
                  <form action="{{route('admin.reports.orders-by-date',array(App::getLocale()))}}" method="post">
                      {{csrf_field()}}
            ...
            <div class="row">
                <div class="panel panel-default filterable" id="print">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">Report - from {{@$from?$from:date('Y-m-d')}} to {{@$to?$to:date('Y-m-d')}}</h3>
