                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.edit-agent',array($agent->id, App::getLocale()))}}">
                                {{ csrf_field() }}
                                <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                                    <label for="username" class="col-md-4 control-label">{{trans('general.username')}}</label>

                                    <div class="col-md-6">
                                        <input id="username" type="text" class="form-control" name="username" value="{{ $agent->username }}" disabled="disabled">
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    <label for="password" class="col-md-4 control-label">{{trans('general.password')}} ({{trans('general.optional')}})</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control" name="name" value="{{ $agent->name }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="email" type="email" class="form-control" name="email" value="{{ $agent->email }}" disabled="disabled">
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="number" class="form-control" name="phone" value="{{ $agent->phone }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('region') ? ' has-error' : '' }}">
                                    <label for="region" class="col-md-4 control-label">{{trans('general.region')}} ({{trans('general.optional')}})</label>
                                    <div class="col-md-6">
                                        <select id="region" class="form-control" name="region[]" multiple="multiple">
                                            @foreach($agentRegions as $reg)
                                                <option value="{{ $reg->id }}">{{$reg->name}}</option>
                                            @endforeach
                                            @foreach($cityRegions as $item)
