                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        @if(Auth::user()->hasRole('superadmin'))
                            <div class="panel-heading">{{trans('general.admin')}}</div>
                        @elseif(Auth::user()->hasRole('admin'))
                            <div class="panel-heading">{{trans('general.new')}} {{trans('general.supervisor')}}</div>
                        @endif
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.edit-admin',[$admin->id,App::getLocale()])}}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="phone" type="number" class="form-control" name="phone" value="{{ $admin->phone }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <select id="city" class="form-control" name="city" required>
                                            <option value="{{$admin->city}}">{{$admin->city}}</option>
