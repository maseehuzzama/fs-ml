...
@section('meta-title')
	...
	<title>{{trans('general.edit-order')}} | {{trans('general.tagline')}}</title>
@endsection
@section('custom-css')
	<style>
		.loadinggif {
				...
				<div class="col-xs-12 {{(App::getLocale() === 'ar') ? 'text-right':''}}" style="border: 1px solid #31708f; padding: 30px;">
					...
					<form method="post" action="{{route('client.edit-order',array(App::getLocale(),$order->id))}}"  class="row">
						...
						<div class="form-section">
							...
							<div id="other_store" class="col-sm-12">
								...
								<div class="form-group col-sm-12 col-md-4">
									...
									<input id="s_other_neighbor" name="s_other_neighbor" type="text" class="form-control" placeholder="" value="{{@$order->s_other_neighbor}}" {{($order->s_neighbor_id == 0)?$order->s_other_neighbor:'disabled="disabled"'}}>
								</div>
								<div class="form-group col-sm-12 col-md-6">
						...
						<div class="form-section col-xs-12"><h3>{{trans('client.rcvr-info')}}</h3>
							...
							<div class="form-group col-sm-12 col-md-6">
								<label for="r_country">{{trans('general.country')}}</label>
							...
							<div class="form-group col-sm-12 col-md-4">
								...
								<input id="r_other_neighbor" name="r_other_neighbor" type="text" class="form-control" placeholder="" value="{{@$order->r_other_neighbor}}" {{$order->r_neighbor_id == 0?$order->r_other_neighbor:'disabled="disabled"'}}>
							</div>
